...
from back_end.users import register_user, get_user
from back_end.data_utilities import list_from_dict
from api.helpers import api_error_response, user_ok_to_view_member
...
def api_register_user():
    #Register a new user
    params = list_from_dict(request.get_json() or {}, ['member_number', 'email', 'user_name', 'password'])
    ok, id, message, message_type = register_user(*params)
